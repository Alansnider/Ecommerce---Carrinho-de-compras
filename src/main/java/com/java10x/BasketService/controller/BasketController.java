...
import com.java10x.BasketService.service.BasketService;
...
public class BasketController {
    ...
    @PutMapping("/{id}/pay")
    public ResponseEntity<Basket> payBasket(@PathVariable String id, @RequestBody PaymentMethod paymentMethod) {
        return ResponseEntity.status(HttpStatus.OK).body(basketService.payBasket(id, paymentMethod));
    }
    @DeleteMapping("/{id}")
